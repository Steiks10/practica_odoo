...
class covid_19(models.Model):
    ...
    total_vaccinated= fields.Integer(string='Total vaccinated', compute='set_total_vaccinated', required=True, default=0)
    ...
    def set_total_vaccinated(self):
        for data in self:
            ...
            data.total_recovered= sum(Vaccinated)+data.recovered 
